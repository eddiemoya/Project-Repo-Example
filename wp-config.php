 ...
 * 
 * After changing the database credentials below, run the following command to 
 * ensure that git doesnt bother you about it.
 *
 * > git update-index --assume-unchanged wp-config.php
 *
 * If for some reason you do need to commit a change to this file to share it with other developers
 * you can undo the --assume-unchanged command by using the same command but with --no-assume-unchanged
 * so for example...
 * 
 * > git update-index --no-assume-unchanged wp-config.php
 */
...
/** 
 * Dynamic URL and custom location for wp-content, which is normally inside with wordpress core
 * directory. This is ONLY for development or testing purposes, do not use this on any production
 * environments
 */
